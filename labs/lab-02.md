...
| Дата останнього crawl              |  19 бер. 2026 р., 23:54:29 |
| Метод виявлення URL                |          |
| Чи дозволено індексацію robots.txt |  Так     |
| Чи є canonical                     |  Так     |
| Статус рендерингу (screenshot)     |          |

![alt text](lab2/screenshots/gsc.jpg)
...
```
![alt text](lab2/screenshots/search-site.jpg)

![alt text](lab2/screenshots/search-cache.jpg)

![alt text](lab2/screenshots/search-info.jpg)
