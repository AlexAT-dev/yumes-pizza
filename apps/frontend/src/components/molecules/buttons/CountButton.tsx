...
export const countButtonStyle = ({
  ...
  'select-none flex flex-row px-[10px] py-[10px] w-[104px] rounded-[20px] items-center justify-center text-heading6 text-dark_gray font-bold bg-light_gray shadow-md cursor-pointer ease-out duration-300',
  counted &&
